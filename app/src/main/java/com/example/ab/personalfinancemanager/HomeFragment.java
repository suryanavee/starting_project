...
public class HomeFragment extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,NetworkConnectivity.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Save Expenses");
    ...
    public void onNetworkConnectionChanged
        ...
        if (isConnected == true) {
           /* AlertDialog.Builder alet = new AlertDialog.Builder(HomeFragment.this);
            ...
            fr.replace(R.id.frame,nointernet);
            fr.commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intent=new Intent(HomeFragment.this,Transaction.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.nav_gallery) {
            Intent intent=new Intent(HomeFragment.this,CreateGroup.class);
            startActivity(intent);
